<template>
  <div class="brokerageKpi-quarterly-exhibition-award">
    <al-all-head>
    ...
    <al-content
      class="brokerageKpi-quarterly-exhibition-award-content"
      ref="insureMessage"
      :tabs="tabs"
      :isMescrollDown="true"
      :isToTop="true"
...
export default {
  name: "bkge-examine-quarterly-exhibition-award", //使用xx-xx-xx命名方式具体看操作文档
  props: {
  ...
  mounted() {
    console.log("%c quarterly-exhibition-award>生命周期>mounted", "color:green;", "");
  },
  watch: {},
  data() {
    return {
...
.brokerageKpi-quarterly-exhibition-award {
  .brokerageKpi-quarterly-exhibition-award-content {
    .content-detail {
