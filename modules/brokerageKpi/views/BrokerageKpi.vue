<template>
  <div class="n22-brokerage-kpi">
    <transition name="n22-base-fade">
      <router-view v-if="isShowRouterView" class="n22-brokerage-kpi-child-view"></router-view>
    </transition>
  </div>
</template>
...
export default {
  name: "brokerage-kpi", //使用xx-xx-xx命名方式具体看操作文档
  props: {
...
.n22-brokerage-kpi {
  .n22-brokerage-kpi-child-view {
    @import "../assets/css/resetField";
  }
}
</style>
