<template>
  <div class="brokerageKpi-my-examine">
    <al-all-head>
      <!--    <al-all-head title="TA的考核">-->
    ...
    <al-content
      class="brokerageKpi-my-examine-content"
      v-model="curIndex"
      :tabs="tabs"
      :swiperTop="swiperTop"
      :isToTop="true"
      :isMescrollLoadList="true"
      :isMescrollDown="true"
    >
...
export default {
  name: "bkge-examine-my-examine", //使用xx-xx-xx命名方式具体看操作文档
  props: {
  ...
  mounted() {
    console.log("%c my-examine>生命周期>mounted", "color:green;", "");
  ...
  methods: {
    ...
    upData(item, i, curIndex) {
      console.log("%c upData upRefreshFun", "color:#00CD00", curIndex);
    },
    $_changeData(itemObj) {
...
.brokerageKpi-my-examine {
  ...
  .brokerageKpi-my-examine-content {
    .my-examine-content {
      margin-top: 10px;
      overflow-y: scroll;
      padding-bottom: 60px;
