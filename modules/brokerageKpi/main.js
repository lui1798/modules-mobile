...
if (globalConfig.httpEnvironment === "local") {
  ...
  // globalConfig.rootUrl = "http://308hi67015.wicp.vip/api"; //process.env.VUE_APP_ROOTURL
  globalConfig.rootUrl = "https://mitphone.sunlife-everbright.com/api";
  // globalConfig.rootUrl = "http://nb.vipgz1.idcfengye.com/api";
  // globalConfig.rootUrl = "http://114.240.149.143:39000/api";
  ...
  globalConfig.gRegion = "ap-chengdu";
  globalConfig.gSecretId = "AKID42pSt9AHBvtkQuQtgJk05zpkT4Xso8A0";
  globalConfig.gSecretKey = "RqW3Sgw6gASaWHwTr45kNo4C9vhOwISP";
}
...
import store from "@m/brokerageKpi/vuex/";
...
const req = require.context("@m/brokerageKpi/assets/icons", false, /\.svg$/);
requireAll(req);
