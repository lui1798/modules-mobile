<template>
  <div class="error_404">
    <!-- 头部信息 -->
    <al-all-head :zIndex="3" title="404" />
    <al-content ref="insureMessage" :headBottom="false">
      <div class="wscn-http404-container">
        <div class="wscn-http404">
          ...
          <div class="bullshit">
            ...
            <router-link to="/" class="bullshit__return-home">返回</router-link>
          </div>
        </div>
      </div>
    </al-content>
