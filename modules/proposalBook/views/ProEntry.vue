<template>
  <div class="proposalBook-pro-entry">
    <al-all-head></al-all-head>
    <al-content
      class="proposalBook-pro-entry-content"
      ref="insureMessage"
      :tabs="tabs"
      :isMescrollDown="true"
      :isToTop="true"
...
export default {
  name: "proposal-book-pro-entry", //使用xx-xx-xx命名方式具体看操作文档
  props: {
  ...
  mounted() {
    console.log("%c pro-entry>生命周期>mounted", "color:green;", "");
  },
  watch: {},
  data() {
    return {
...
.proposalBook-pro-entry {
  .proposalBook-pro-entry-content {
  }
}
</style>
