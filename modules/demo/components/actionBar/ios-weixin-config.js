 ...
 * @Last Modified time: 2019-11-13 11:38:00
 * @Desc 在特定的js调用
 */
...
export default {
  ...
  wxConfig() {
    let promise = new Promise(function(resolve, reject) {
      if (true) {
        let url =
          "http://show.n22.com.cn:8785/api/@module/intweixin/getConfig?param=" +
  ...
  hideAllNonBaseMenuItem() {
    ...
    function onBridgeReady() {
      console.log("%c utils-wechat-hideAllNonBaseMenuItem", "color:green;", "微信禁用调用成功！");
