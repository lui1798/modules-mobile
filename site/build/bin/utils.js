...
function stdout(title, msg) {
  process && process.stdout && process.stdout.clearLine && process.stdout.clearLine()
  process && process.stdout && process.stdout.cursorTo && process.stdout.cursorTo(0)
  process && process.stdout && process.stdout.write && process.stdout.write(`${chalk.yellow.bold(title)} ${msg}`)
}
