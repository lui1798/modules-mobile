<template>
  <div class="homeTest-my-view">
    <al-all-head></al-all-head>
    <al-content
      class="homeTest-my-view-content"
      ref="insureMessage"
      :tabs="tabs"
      :isMescrollDown="true"
      :isToTop="true"
...
export default {
  name: "home-test-my-view", //使用xx-xx-xx命名方式具体看操作文档
  props: {
  ...
  mounted() {
    console.log("%c homeTest-生命周期-mounted", "color:green;", "");
  },
  watch: {},
  data() {
    return {
