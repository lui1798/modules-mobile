...
const demo = () => import(/* webpackChunkName: "demo" */ "@m/demo/views/demo/Demo.vue");
const allDemo = () => import(/* webpackChunkName: "demoallDemo" */ "@m/demo/views/demo/AllDemo.vue");
const demoDetail = () => import( /* webpackChunkName: "demodemoDetail" */ '@m/demo/views/demo/DemoDetail.vue')
/* @init<%const ${viewKebabUpper} = () => import( ${webpackChunkName} '@m/demo/views/${moduleKebabUpper}/${viewKebabNameUpper}.vue')%> */
export default [
    {
        name: "demo",
        path: "/demo",
