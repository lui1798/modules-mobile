<template>
  <div id="app" ref="app" class="nprogress-wrap app_class" :class="_module">
    <!-- <transition name="n22-base-scale"> -->
    <!-- <al-all-head v-if="common.isShowRouterView&&transitionName==='slide-in'" :headBottom="false" :zIndex="5" :title="$route.meta.title"/> -->
    <!-- </transition> -->
    ...
    <div class="app_login_popup" v-if="showlogin">
      <!-- <login :changeshowlogin="changeshowlogin" :showlogin="showlogin" v-if="showlogin"></login> -->
    </div>
    <!-- 全局搜索 -->
    <transition :name="searchTransitionName">
      <div class="app_login_popup" v-if="showsearch">
        <!-- <n22-search
          :searchAutoFocus="showsearch"
          v-model="searchValue"
          :hotSearchListProp="hotSearchListProp"
          @search="onSearch"
